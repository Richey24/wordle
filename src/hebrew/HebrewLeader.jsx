...
const HebrewLeader = () => {
    ...
    useEffect(() => {
        (async () => {
            ...
            const arr = rep.sort((a, b) => b.hebrewScore - a.hebrewScore)
            setUsers(arr)
            setSpin(false)
        })()
                ...
                <Container>
                    ...
                    <Row>
                        <Col className="text-center mt-5 mb-5">
                            <h3 className="text-white">Hebrew Word Weekly Leader Board</h3>
                        </Col>
                    </Row>
